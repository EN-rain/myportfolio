...
export const socialMedia = [
  ...
  {
    id: 4,  // Adjusted the id to avoid duplicates
...
const Footer = () => {
  return (
    <footer className="w-full pt-20 pb-10" id="contact">
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center ml-5 -mb-[150px]">
